<div>
    <section class="p-0 no-transition cursor-light" id="home">
        ...
        <div class="rev_slider_wrapper fullscreen-container" data-alias="megaone-agency-1" data-source="gallery" id="rev_slider_17_1_wrapper" style="background:transparent;padding:0;">
                ...
                <ul>
                    <li data-description="" data-easein="default" data-easeout="default" data-hideafterloop="0"
                        ...
                        <div class="tp-caption tp-resizeme hide-cursor"
                            ...
                            {{ __('home.Scroll Down') }}
                            <i class="ml-2 fas fa-long-arrow-alt-down"></i>
                        </div>
                    </li>
                </ul>
